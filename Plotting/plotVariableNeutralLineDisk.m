...
% Plots a rendered disk of a variable neutral line manipulator at coordinate 
% frame T{1'} based on the paper: 
% "Modeling and Control of Robotic Surgical Platform for Single-Port Access 
% Surgery" by 
% Jusuk Lee, Jiyoung Kim, Kwang-Kyu Lee, Seungyong Hyung,
% Yong-Jae Kim, Woong Kwon, Kyungshik Roh, and Jung-Yun Choi
%
% Use: 
% plotVariableNeutralLineDisk(T,w,alpha,d)
%
%Parameters are:
% T = 4x4 homogeneous transform at T{1'}
