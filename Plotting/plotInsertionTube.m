...
% Plots the insertion tube for of a variable neutral line manipulator 
% behind the Baseframe of the snake robot including a rendered curve plotted
% at Baseframe to begin plotting the snake robot.
%
% Use: 
% plotInsertionTube(Baseframe,w,alpha,L,pan_first)
% 
%Parameters are:
% Baseframe = 4x4 transform matrix that is the base of the variable neutral line manipulator
%             not the Entrance frame
% w = the diameter of the simulated tube
% alpha = the contact angle of the curved surface on the top of the tube
%         for a proximal segment
% L = the constant length of the tube below Baseframe
% pan_first = a boolean that desribes if the first proximal joint 
%
