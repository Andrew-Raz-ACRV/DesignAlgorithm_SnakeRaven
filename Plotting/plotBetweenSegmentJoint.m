...
% the distal segment
%
% plotBetweenSegmentJoint(T,w,sigma,zeta,alpha1,alpha2)
%
%Parameters are:
...
% alpha1 = half the contact angle for Segment 1 (lower proximal)
% alpha2 = half the contact angle for Segment 2 (upper distal)
% 
