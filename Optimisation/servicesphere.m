function new_map = servicesphere(Rend,V,Vcoord)
...
if (jj<1)||(jj>Nh)||(ii<1)||(ii>Ntheta)
    ...
    surface = sphere_maps(   ((a-1)*Ntheta+1):(a*Ntheta), ...
                ((b-1)*Nh+1):(b*Nh), ...
                   c)

    surface(jj,ii) = 1; %ii is theta, jj is h
    %update point with prior
    surface = surface|surface_prior;
end
